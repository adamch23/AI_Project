...
- Assure-toi que les défis sont réalistes et évaluent vraiment les compétences`;
  ...
  const executeCode = () => {
    ...
    try {
      ...
      setOutput(String(result) || 'Code exécuté avec succès');
    } catch (error) {
          ...
          <div style={{
            ...
            <label htmlFor="file-upload" style={{ cursor: 'pointer' }}>
              <span style={{ fontSize: '1.2rem', fontWeight: '600', color: '#667eea' }}>
                {loading ? 'Extraction en cours...' : 'Cliquez pour uploader'}
              </span>
              {!loading && <span style={{ color: '#718096' }}> ou glissez-déposez</span>}
            </label>
          ...
          <div style={styles.leftPanel}>
            ...
            {challenge.tests && challenge.tests.length > 0 && (
              <div style={styles.challengeSection}>
                ...
                <ul style={{ fontSize: '0.9rem', color: '#4b5563' }}>
